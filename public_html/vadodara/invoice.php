...
$pdf->AddPage();
		...
		$pdf->Cell(0,5,'102-Aman Square, Besides Chamunda Restaurant',0,1,0);
		$pdf->Cell(0,5,'Behind Fatehgunj Petrol Pump,',0,1,0);
		$pdf->Cell(0,5,'Vadodara, Gujarat 395002',0,1,0);
...
$pdf->Cell(50,5,'097378 84319',0,1,'L');
