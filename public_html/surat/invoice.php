...
$pdf->AddPage();
	    ...
	    $pdf->Cell(0,5,'601 21st Century Business Centre Ring Road',0,1,0);
		$pdf->Cell(0,5,'Besides World Trade Centre, Udhana Darwaja,',0,1,0);
		$pdf->Cell(0,5,'Surat, Gujarat 395002',0,1,0);		
...
$pdf->Cell(50,5,'070433 51659',0,1,'L');
