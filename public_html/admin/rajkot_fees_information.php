...
<body>
	...
	<form action="rajkot_fees_information.php" method="POST">
...
echo "<p align='center'>Pages:";
	...
	for($b=1; $b<=$a; $b++) 
	{
	?><a href="rajkot_fees_information.php?page=<?php echo $b;?>&&course=<?php echo $course;?>" style="text-decoration: none"><?php echo $b." ";?></a> <?php
	    
	}
 ?>
</p>
<br><br>
<input type="button"   onclick="location.href = 'rajkot_export_revenue.php?course=<?php echo $course;?>';"  value="Export"/>
<br><br><br><br>
<?php
...
echo "<p align='center'>Pages:";
	...
	for($b=1; $b<=$a; $b++) 
	{
	?><a href="rajkot_fees_information.php?page=<?php echo $b;?>" style="text-decoration: none"><?php echo $b." ";?></a> <?php
	    
	}
	 ?>
</p>
<br><br>
<input type="button"   onclick="location.href = 'rajkot_export_revenue.php?';"  value="Export"/>
<br><br><br><br>
<?php
