...
<input type="submit" style="float: left; margin-left: 15%"  onclick="location.href = 'anand_expenditure_add.php';" value="Add Expenditure"/>
<br><br><br>
...
$stmt = "SELECT * from expenditure ORDER BY id DESC limit $page1,30 ";
	...
	if ($stmt_exec-> num_rows > 0) {
		while ($row = $stmt_exec->fetch_assoc()) {
                ...
                <a href="anand_edit_expenditure.php?id=<?php echo $row['id'] ?>"><font color=blue>Edit</font></a>
                    </td>
				</tr>
<?php
...
echo "<p align='center'>Pages:";
	...
	for($b=1; $b<=$a; $b++) 
	{
	?><a href="anand_expenditure.php?page=<?php echo $b;?>" style="text-decoration: none"><?php echo $b." ";?></a> <?php   
	}
	 ?>
   	<br><br>	
	<input type="button"   onclick="location.href = 'anand_export_expenditure.php?';"  value="Export"/>
	<br><br><br><br>
	<?php
}
?>
