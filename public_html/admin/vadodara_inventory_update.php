...
$book_id = $_REQUEST['book_id'];
	$stmt = "SELECT book_name from vadodara where book_id= '$book_id'";
...
if (isset($_POST['update'])) 
	{
		...
		$stmt1 = "UPDATE vadodara SET ah_available = ah_available + '$updavail' where book_id= '$book_id'";
...
<input type="submit" style="float: left;"  onclick="location.href = 'vadodara_inventory_disp.php';" value="Back"/>
</body>
</html>