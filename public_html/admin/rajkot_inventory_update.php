...
$book_id = $_REQUEST['book_id'];
	$stmt = "SELECT book_name from rajkot where book_id= '$book_id'";
...
if (isset($_POST['update'])) 
	{
		...
		$stmt1 = "UPDATE rajkot SET ra_available = ra_available + '$updavail' where book_id= '$book_id'";
...
<input type="submit" style="float: left;"  onclick="location.href = 'rajkot_inventory_disp.php';" value="Back"/>
</body>
</html>