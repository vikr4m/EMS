...
<body>
	...
	<form action="surat_course.php" method="POST">
...
echo "<p align='center'>Pages:";
	...
	for($b=1; $b<=$a; $b++) 
	{
	?><a href="surat_course.php?page=<?php echo $b;?>&&name=<?php echo $course;?>" style="text-decoration: none"><?php echo $b." ";?></a> <?php
	    
	}

   	?>
   	<br><br>	
	<input type="button"   onclick="location.href = 'surat_export_program.php?name=<?php echo $course;?>';"  value="Export"/>
	<br><br><br><br>
	<?php
