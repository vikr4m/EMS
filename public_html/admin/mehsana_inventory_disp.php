...
echo "<p align='center'>Pages:";
	...
	for($b=1; $b<=$a; $b++) 
	{
	?><a href="mehsana_inventory_disp.php?page=<?php echo $b;?>&&program=<?php echo $program;?>" style="text-decoration: none"><?php echo $b." ";?></a> <?php
	}
	?>
</p>
<br><br>

<input type="button"   onclick="location.href = 'mehsana_export_inventory.php?name=<?php echo $program;?>';"  value="Export"/>
<br><br><br><br>
<?php	
...
echo "<p align='center'>Pages:";
	...
	for($b=1; $b<=$a; $b++) 
	{
	?><a href="mehsana_inventory_disp.php?page=<?php echo $b;?>" style="text-decoration: none"><?php echo $b." ";?></a> <?php
...
<input type="button"   onclick="location.href = 'mehsana_export_inventory.php?';"  value="Export"/>
<br><br><br><br>
<?php	
