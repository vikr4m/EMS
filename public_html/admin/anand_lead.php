...
<input type="button" style="float: left; margin-left: 10%"  onclick="location.href = 'anand_lead_add.php';" value="Add Lead"/>
	...
	if ($result =$conn->query($table_query))
	 {
		...
		<td align="center">
                ...
                <a href="anand_edit_lead_add.php?id=<?php echo $row['id'] ?>"target="_blank"><font color=blue>Edit</font></a>	
                |
                <a onclick='confirmdelete();return false;' href="anand_lead_delete.php?id=<?php echo $row['id'] ?>"><font color=red>Delete</font></a>
...
echo "<p align='center'>Pages:";
	...
	for($b=1; $b<=$a; $b++) 
	{
	?><a href="anand_lead.php?page=<?php echo $b;?>&&name=<?php echo $datas;?>" style="text-decoration: none"><?php echo $b." ";?></a> <?php
...
<input type="button"   onclick="location.href = 'anand_export_leads.php?name=<?php echo $datas;?>';"  value="Export"/>
<br><br><br><br>
<?php	
}
...
echo "<p align='center'>Pages:";
	...
	for($b=1; $b<=$a; $b++) 
	{
	?><a href="anand_lead.php?page=<?php echo $b;?>" style="text-decoration: none"><?php echo $b." ";?></a> <?php
...
<input type="button"   onclick="location.href = 'anand_export_leads.php?';"  value="Export"/>
<br><br><br><br>
<?php
