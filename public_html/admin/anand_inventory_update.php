...
$book_id = $_REQUEST['abook_id'];
	$stmt = "SELECT book_name from anand where abook_id= '$book_id'";
...
if (isset($_POST['update'])) 
	{
		...
		$stmt1 = "UPDATE anand SET available = available + '$updavail' where abook_id= '$book_id'";
...
<input type="submit" style="float: left;"  onclick="location.href = 'anand_inventory_disp.php';" value="Back"/>
</body>
</html>