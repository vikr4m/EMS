...
<input type="button" style="float: left; margin-left: 10%"  onclick="location.href = 'ahmedabad_student_add.php';" value="Add Student"/>
<br>
<br>
  ...
  if ($result =$conn->query($table_query))
   {
    ...
    ?>
      <tr>
          ...
          <td align="center"><a href="ahmedabad_student_profile.php?sid=<?php echo $value['sid'] ?>"><font color=blue><?php echo $value['sname']; ?></font></a></td>
        ...
        <td align="center">
                ...
                <a href="ahmedabad_edit_student_add.php?sid=<?php echo $value['sid'] ?>"target="_blank"><font color=blue>Edit</font></a>
                |
                <a onclick='confirmdelete();return false;' href="ahmedabad_delete.php?sid=<?php echo $value['sid'] ?>"><font color=red>Delete</font></a>
...
echo "<p align='center'>Pages:";
  ...
  for($b=1; $b<=$a; $b++) 
  {
  ?><a href="ahmedabad_student.php?page=<?php echo $b;?>&&name=<?php echo $datas;?>"  style="text-decoration: none"><?php echo $b." ";?></a> <?php
      
  }
  ?>
</p>
<br><br>
<input type="button"   onclick="location.href = 'ahmedabad_export_student.php?name=<?php echo $datas;?>';"  value="Export"/>
<br><br><br><br>
<?php
}
...
echo "<p align='center'>Pages:";
  ...
  for($b=1; $b<=$a; $b++) 
  {
  ?><a href="ahmedabad_student.php?page=<?php echo $b;?>" style="text-decoration: none"><?php echo $b." ";?></a> <?php
      
  }
    ?>
</p>
<br><br>
<input type="button"   onclick="location.href = 'ahmedabad_export_student.php?';"  value="Export"/>
<br><br><br><br>
<?php
}
?>    
...
function confirmdelete()
{
   ...
   if(conf)
     {
       header("location:ahmedabad_delete.php");
     }
