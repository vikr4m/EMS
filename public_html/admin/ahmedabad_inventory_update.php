...
$book_id = $_REQUEST['book_id'];
	$stmt = "SELECT book_name from ahmedabad where book_id= '$book_id'";
...
if (isset($_POST['update'])) 
	{
		...
		$stmt1 = "UPDATE ahmedabad SET ah_available = ah_available + '$updavail' where book_id= '$book_id'";
...
<input type="submit" style="float: left;"  onclick="location.href = 'ahmedabad_inventory_disp.php';" value="Back"/>
</body>
</html>