...
$book_id = $_REQUEST['book_id'];
	$stmt = "SELECT book_name from gandhinagar where book_id= '$book_id'";
...
if (isset($_POST['update'])) 
	{
		...
		$stmt1 = "UPDATE gandhinagar SET ga_available = ga_available + '$updavail' where book_id= '$book_id'";
...
<input type="submit" style="float: left;"  onclick="location.href = 'gandhinagar_inventory_disp.php';" value="Back"/>
</body>
</html>