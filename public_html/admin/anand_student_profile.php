...
<body>
<br>
<input type="submit" style="float: left;"  onclick="location.href = 'anand_student.php';" value="Back"/>
<?php
$sid=$_REQUEST['sid'];
?>
<br>
...
<h2 >Add New Book </h2>     
<?php
include "anand_inventory_logic.php";
?>
...
<table border="1"  style="border-collapse: collapse;" align="center" width="50%">
  ...
  <tr>
    ...
    <td align="center">
                <a onclick='confirmremove();return false;' href="anand_remove.php?bno=<?php echo $value['bno']?> "><font color=red>Remove</font></a>
    </td>        
  </tr>
...
function confirmremove()
{
   ...
   if(conf)
     {
       header("location:anand_remove.php");
     }
