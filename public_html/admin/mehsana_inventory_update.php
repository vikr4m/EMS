...
$book_id = $_REQUEST['book_id'];
	$stmt = "SELECT book_name from mehsana where book_id= '$book_id'";
...
if (isset($_POST['update'])) 
	{
		...
		$stmt1 = "UPDATE mehsana SET me_available = me_available + '$updavail' where book_id= '$book_id'";
...
<input type="submit" style="float: left;"  onclick="location.href = 'mehsana_inventory_disp.php';" value="Back"/>
</body>
</html>