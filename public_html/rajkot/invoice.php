...
$pdf->AddPage();
		...
		$pdf->Cell(0,5,'3rd Floor,Balaji House 52 Janta Society, Above FabIndia,',0,1,0);
		$pdf->Cell(0,5,'Opp. LIC Of India, Mahila College Chowk,',0,1,0);
		$pdf->Cell(0,5,'Rajkot, Gujarat 360001',0,1,0);
...
$pdf->Cell(50,5,'076240 11227',0,1,'L');
