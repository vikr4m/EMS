...
$pdf->AddPage();
		...
		$pdf->Cell(0,5,'A-508, 5th Floor, Vrundavan Trade Center',0,1,0);
		$pdf->Cell(0,5,'VTC Nr, Reliance Cross Rd, Urjanagar 1,',0,1,0);
		$pdf->Cell(0,5,' Kudasan, Gandhinagar, Gujarat 382421',0,1,0);
...
$pdf->Cell(50,5,'6356061801',0,1,'L');
