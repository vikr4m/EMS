...
$pdf->AddPage();
		...
		$pdf->Cell(0,5,'5, 2nd Floor, Satatya Complex',0,1,0);
		$pdf->Cell(0,5,'below LIC of India, near Hubtown',0,1,0);
		$pdf->Cell(0,5,'Mehsana, Gujarat 384001',0,1,0);
...
$pdf->Cell(50,5,'063564 80097',0,1,'L');
